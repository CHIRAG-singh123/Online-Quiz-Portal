...
#change password
    ...
    url(r'^password/$', views.change_password_admin, name='change_password_admin'),
#csv 
    path('admin-csv-question/', views.admin_csv_question, name='admin-csv-question'),
    path('admin-csv-course/', views.admin_csv_course, name='admin-csv-course'),
